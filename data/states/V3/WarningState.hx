...
function postCreate() {
	...
	var bg:FlxSprite = CoolUtil.loadAnimatedGraphic(new FlxSprite(), Paths.image('menus/V3/titlescreen/titleThing'));
	...
	var screen:FlxSprite = new FlxSprite().loadGraphic(Paths.image("menus/V3/warning/lol"));
	screen.angle = -3;
	add(screen);
