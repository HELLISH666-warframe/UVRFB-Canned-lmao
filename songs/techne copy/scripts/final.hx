...
function beatHit(curBeat:Int){
    ...
    if (curBeat == 32){
        ...
        FlxTween.color(stage.getSprite("pentycanvas"), {color: 0xFFFFFFFF}, 3,{ease: FlxEase.linear});
    ...
    if (curBeat == 38){
        FlxTween.tween(stage.getSprite("penty"), {y: -1500}, 0.75, {ease: FlxEase.quadOut});
    }
    if (curBeat == 40){
    ...
    if (curBeat == 104){
        ...
        FlxTween.tween(stage.getSprite("penty"), {y: -3750}, 1.25, {ease: FlxEase.quadIn});
    ...
    if (curBeat == 156){
        ...
        FlxTween.tween(stage.getSprite("penty"), {y: -2750}, 5.5, {ease: FlxEase.quadIn});
    ...
    if (curBeat == 476){
        ...
        FlxTween.tween(boyfriend, {y: -11800}, 1.5, {ease: FlxEase.quadIn});
        FlxTween.tween(dad, {y: -12000}, 1.5, {ease: FlxEase.quadIn});
        FlxTween.tween(stage.getSprite("penty"), {x: -4750}, 1.25, {ease: FlxEase.quadIn});
        FlxTween.tween(boyfriend, {angle: 360}, 1, {ease: FlxEase.quadIn});
        FlxTween.tween(stage.getSprite("alive"), {alpha: 1}, 1, {ease: FlxEase.quadIn});
        defaultCamZoom=0.4;
...
function postUpdate(elapsed:Float){
    ...
    stage.getSprite("hind").y=boyfriend.y+200;
    stage.getSprite("noskin").y=boyfriend.y-850;
    ...
    if (curBeat <= 464){
        stage.getSprite("island").x=dad.x-300;
        stage.getSprite("island").y=dad.y+375;
        stage.getSprite("island2").x=boyfriend.x+-125;
        stage.getSprite("island2").y=boyfriend.y+200;
    }
    if (curBeat >= 108){
