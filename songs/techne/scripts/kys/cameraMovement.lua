...
function onUpdatePost()
   ...
   if followchars and startCam then
      ...
      if curBeat >= 38 and curBeat < 72 then
         if startsWith(anim, "singLEFT") then
            camOffY = 0 -375;
            camOffX = 0 - Intensity; -- this
         end
         ...
         if startsWith(anim, "singUP") then
            camOffX = 0;
            camOffY = 0 - Intensity -375;
         end
         if startsWith(anim, "singDOWN") then
            camOffX = 0;
            camOffY = Intensity -375;
         end
         if startsWith(anim, "idle") then
            camOffX = 0;
            camOffY = -375;
      ...
      if curBeat >= 72 and curBeat < 108 then
         if startsWith(anim, "singLEFT") then
            camOffY = 0 -275;
            camOffX = 0 - Intensity; -- this
         end
         ...
         if startsWith(anim, "singUP") then
            camOffX = 0;
            camOffY = 0 - Intensity -275;
         end
         if startsWith(anim, "singDOWN") then
            camOffX = 0;
            camOffY = Intensity -275;
         end
         if startsWith(anim, "idle") then
            camOffX = 0;
            camOffY = -275;
      ...
      if curBeat >= 108 and curBeat < 550 then
         if startsWith(anim, "singLEFT") then
            camOffY = 0;
            camOffX = 0 - Intensity; -- this
         end
      ...
      if curBeat >= 550 and curBeat < 556 then
         if startsWith(anim, "singLEFT") then
            camOffY = 0 -375;
            camOffX = 0 - Intensity; -- this
         end
      ...
      if curBeat >= 556 then
         ...
         if startsWith(anim, "singUP") then
            camOffX = 0;
            camOffY = 0 - Intensity -125;
         end
         if startsWith(anim, "singDOWN") then
            camOffX = 0;
            camOffY = Intensity -125;
         end
         if startsWith(anim, "idle") then
            camOffX = 0;
            camOffY = -125;
